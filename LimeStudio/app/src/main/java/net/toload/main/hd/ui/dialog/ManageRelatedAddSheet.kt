 ...
 */
class ManageRelatedAddSheet : BottomSheetDialogFragment() {
    private var hostFragment: ManageRelatedFragment? = null
    private var score = 0

    fun setFragment(fragment: ManageRelatedFragment?) {
    ...
    companion object {
        @JvmStatic
        fun newInstance(): ManageRelatedAddSheet = ManageRelatedAddSheet()
    }
}

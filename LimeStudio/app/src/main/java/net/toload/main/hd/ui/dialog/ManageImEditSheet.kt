 ...
 */
class ManageImEditSheet : BottomSheetDialogFragment() {
    private var hostFragment: ManageImFragment? = null
    private var record: Record? = null
    private var score = 0

    fun setFragment(fragment: ManageImFragment?, record: Record?) {
        hostFragment = fragment
        this.record = record
        score = record?.getScore() ?: 0
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val edtCode = view.findViewById<TextInputEditText>(R.id.edt_code)
        ...
        if (currentRecord != null) {
            edtCode.setText(currentRecord.getCode())
            edtWord.setText(currentRecord.getWord())
            ...
            AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton(R.string.dialog_confirm) { _, _ ->
                    ...
                    if (hostFragment != null && item != null) {
                        hostFragment?.removeRecord(item.getIdAsInt())
                    }
                    dismiss()
                }
        ...
        view.findViewById<View>(R.id.btn_save).setOnClickListener {
            ...
            AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton(R.string.dialog_confirm) { _, _ ->
                    val item = record
                    if (hostFragment != null && item != null) {
                        hostFragment?.updateRecord(item.getIdAsInt(), code, score, word)
                    }
                    dismiss()
                }
                .setNegativeButton(R.string.dialog_cancel, null)
    ...
    private fun validateInput(code: String, word: String): Boolean {
        return code.isNotEmpty() && word.isNotEmpty()
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): ManageImEditSheet = ManageImEditSheet()
    }
}

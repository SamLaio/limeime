...
public class CandidateViewTest {
    ...
    public void dictationDisplayTextReflectsStateAndPartialText() {
        ...
        assertEquals(resources.getString(R.string.dictation_status_listening),
                CandidateView.dictationDisplayText(resources, DictationState.LISTENING, null));
        assertEquals("這是測試", CandidateView.dictationDisplayText(resources, DictationState.PARTIAL, "這是測試"));
        assertEquals(resources.getString(R.string.dictation_status_finalizing),
                CandidateView.dictationDisplayText(resources, DictationState.FINALIZING, null));
        assertEquals(resources.getString(R.string.dictation_status_error),
                CandidateView.dictationDisplayText(resources, DictationState.ERROR, null));
